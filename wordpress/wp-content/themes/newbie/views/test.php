...
<div class="sub-header clearfix ">
	<div class="row">
		...
		<div class="pull-left col-xs-2 col-lg-1 subnav-btn">
			<a class="submit-btn btn"
				ng-confirm-click="Zeker dat je '{{checklist.title.rendered}}' wilt verwijderen?"
				confirmed-click="deletePost(checklist.id)"><i class="icon icon-trash"></i></a>
		</div>
						...
						<div ng-repeat="item in checklist.acf.ag_repeater_checklist">
							<div class="item">
								...
								<div class="form-group list-group-item">
										<!-- true / false -->
									<input type="hidden" name="fields[ag_repeater_checklist][{{$index}}][ag_true_false]" value="0" />
									<input id="fields[ag_repeater_checklist][{{$index}}][ag_checklist_item]" ng-model="data.currentUser.acf.is_de_baby_geboren" type="checkbox" name="fields[ag_repeater_checklist][{{$index}}][ag_true_false]">
