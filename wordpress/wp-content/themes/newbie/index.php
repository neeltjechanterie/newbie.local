...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo get_stylesheet_directory_uri();?>/style/img/apple-touch-icon.png">
    <link rel="icon" href="<?php echo get_stylesheet_directory_uri();?>/style/img/favicon.png">

    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?php echo get_stylesheet_directory_uri();?>/style/img/win8-tile-icon.png">
    <?php wp_head(); ?>
    <link rel='stylesheet' id='style-css'  href='<?php echo get_stylesheet_directory_uri();?>/style.css' type='text/css' media='all' />
    <link rel='stylesheet' id='style-css-bootstrap'  href='<?php echo get_stylesheet_directory_uri();?>/style/css/bootstrap.css' type='text/css' media='all' />
    <link rel='stylesheet' id='style-css-grid-bootstrap'  href='<?php echo get_stylesheet_directory_uri();?>/style/css/bootstrap-grid.css' type='text/css' media='all' />
    ...
    <script type='text/javascript' src='<?php echo get_stylesheet_directory_uri();?>/style/js/main.js'></script>
</head>
